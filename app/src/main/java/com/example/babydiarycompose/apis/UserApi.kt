...
class UserApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun updateUser(body: User, username: kotlin.String) : Unit {
        val localVarResponse = updateUserWithHttpInfo(body = body, username = username)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun updateUserWithHttpInfo(body: User, username: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = updateUserRequestConfig(body = body, username = username)
     ...
     * @return RequestConfig
     */
    fun updateUserRequestConfig(body: User, username: kotlin.String) : RequestConfig<User> {
        val localVariableBody = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
